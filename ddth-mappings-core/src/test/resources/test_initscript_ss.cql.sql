...
DROP TABLE IF EXISTS ss_mappings_stats;
CREATE TABLE ss_mappings_stats (
    m_mapping               VARCHAR,
    m_namespace             VARCHAR,
    m_key                   VARCHAR,
    m_value                 COUNTER,
...
DROP TABLE IF EXISTS ss_mapoo_data;
CREATE TABLE ss_mapoo_data (
    m_namespace             VARCHAR,
    m_type                  VARCHAR,
    m_key                   VARCHAR,
    m_data                  BLOB,
...
DROP TABLE IF EXISTS ss_mapmm_data;
CREATE TABLE ss_mapmm_data (
    m_namespace             VARCHAR,
    m_type                  VARCHAR,
    m_key                   VARCHAR,
    m_value                 VARCHAR,
...
DROP TABLE IF EXISTS ss_mapmo_objtarget;
CREATE TABLE ss_mapmo_objtarget (
    m_namespace             VARCHAR,
    m_object                VARCHAR,
    m_data                  BLOB,
...
DROP TABLE IF EXISTS ss_mapmo_targetobj;
CREATE TABLE ss_mapmo_targetobj (
    m_namespace             VARCHAR,
    m_target                VARCHAR,
    m_object                VARCHAR,
    m_data                  BLOB,
